...
//    particles.computeSpringForcesAndTorques(side, bonds, Lcp, k_spring);
    ...
    particles.computeForcesAndTorques(pairs, side, max_site_type);
    particles.computeNonPatchForcesAndTorques(pairs, side, max_site_type);
...
//    if (t % 1000 == 0) particles.computeAngles(t, dt, pairs, side, max_site_type);
//    if (t % 100000 == 0) particles.writeBondStats(t, dt, bonds);
//    if (t % 100000 == 0) particles.writeBondStats(t, dt, bonds);
    if (t % 10000 == 0) particles.writeContactsABandAAorBB(t, dt, side);
//    if (t % 10000 == 0) particles.writeContactsAB(t, dt, side);
//    if (t % 10000 == 0) particles.writeContactsAAorBB(t, dt, side);
//    if (t % 10000 == 0) particles.writeContactsALL(t, dt, side);
