...
class ParticleCollection : public std::vector<Particle> {
  public:
    ...
    void computeForcesAndTorques(const PairList pairs_, double side_,size_t max_site_type);
    void computeNonPatchForcesAndTorques(const PairList pairs_, double side_,size_t max_site_type);
    void computeAngles(long long t_, double dt_, const PairList pairs_, double side_,size_t max_site_type);
    ...
    void writeContactsAB(long long t_, double dt_, double side_);
    void writeContactsAAorBB(long long t_, double dt_, double side_);
    void writeContactsABandAAorBB(long long t_, double dt_, double side_);
    void writeContactsALL(long long t_, double dt_, double side_);
